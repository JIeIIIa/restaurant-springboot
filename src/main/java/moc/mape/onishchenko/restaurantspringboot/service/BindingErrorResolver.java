...
public class BindingErrorResolver {
    ...
    @Autowired
    public BindingErrorResolver(MessageSource messageSource) {
        this.messageSource = messageSource;
    }

    public String resolveMessage(String key) {
        return resolveMessage(key, null, LocaleContextHolder.getLocale());
    }
    ...
    public String resolveMessage(ObjectError error) {
        return resolveMessage(error, LocaleContextHolder.getLocale());
    ...
    public List<String> resolveAllMessages(List<ObjectError> errors) {
        return resolveAllMessages(errors, LocaleContextHolder.getLocale());
